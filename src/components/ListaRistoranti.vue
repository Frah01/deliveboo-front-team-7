...
<template lang="">
    <div class="container">
        <input class="search_bar mt-3" type="text" placeholder="cerca il tuo ristorante preferito" v-model="search_title" @keyup="filterRestaurants">
        <div class="row">
            <div class="col-12 d-flex flex-wrap">
                <!-- <div class="col-4 " v-for="restaurant in restaurants" :key= "restaurant.id" > -->
                <div class="col-4" v-for="restaurant in this.restaurants" :key= "restaurant.id" >
