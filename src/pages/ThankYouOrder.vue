...
<template lang="">
    <div>
        <div v-if="loading" class="container-loader">
            <h1>Stiamo inviando il tuo ordine...</h1>
            <div class="loader">
            </div>
        </div>
        <div v-else class="container-content">
            <h1 class="grazie">Grazie per aver ordinato da Deliveboo!</h1>
            <p>Abbiamo preso in carico il tuo ordine, a breve riceverai una mail di conferma con tutte le indicazioni!</p>
            <router-link :to="{ name : 'homepage'}" class="bottone-thankyou" >Torna alla Homepage</router-link>
        </div>
    </div>
</template>
<style lang="scss" scoped>
    ...
    .container-loader{
        ...
        .loader {
            ...
            100%   {-webkit-mask:conic-gradient(#0000 0deg,#000 0)}
            }
    }
}
    ...
    .container-content{
        ...
        .bottone-thankyou {
            ...
            color: white;
            border: none;
            background: linear-gradient(120deg, darkmagenta, #00CDBE, #D0EB99);
